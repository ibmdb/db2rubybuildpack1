...
echo "laying down DB2 ODBC Driver...."
wget ftp://db2ftp.torolab.ibm.com/devinst/db2_v105fp3/linuxamd64/s131217/v10.5fp4_linuxx64_odbc_cli.tar.gz

echo "wget DB2 ODBC driver done"

tar zxvf ibm_data_server_driver_for_odbc_cli_linuxx64_v10.5.tar.gz -C ${DESTINATION}
(
  export IBM_DB_HOME="$DESTINATION/odbc_cli/clidriver"
  export LD_LIBRARY_PATH="$DESTINATION/odbc_cli/clidriver/lib:$LD_LIBRARY_PATH"
)
echo "Done laying out DB2 ODBC and setting vars"
